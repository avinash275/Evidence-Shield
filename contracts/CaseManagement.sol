...
contract CaseManagement {
    ...
    function getCaseBooleans(uint _caseID) public view returns (bool police, bool lab, bool hospital) {
        return (policeBool[_caseID], labBool[_caseID], hospitalBool[_caseID]);
    }
